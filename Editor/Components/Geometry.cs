...
namespace Editor.Components
{
    ...
    public class Geometry : Component
    {
        ...
        public override void Load()
        {
            ...
            Debug.Assert(_materials.All(x => x.UploadedAsset is not null && Id.IsValid(x.UploadedAsset.ContentId)));
                ...
                GeometryWithMaterials = new(
                    ...
                    [.. metadata.LODs.Select(lod => new LODWithMaterials(
                        ...
                        [.. lod.Meshes.Select(mesh => new MeshWithMaterial(
                            mesh,
                            index < _materials.Count ? Materials[index++] : CreateAndUploadAppliedMaterial(Material.Default)
                        ))]
                    ))]
                );
            }
