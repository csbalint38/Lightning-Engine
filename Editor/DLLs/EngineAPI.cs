...
static partial class EngineAPI
{
    ...
    [LibraryImport(_engineDll, EntryPoint = "update_editor_camera")]
    private static partial void UpdateEditorCamera(
        int surfaceId,
        float posX,
        float posY,
        float posZ,
    ...
    [LibraryImport(_engineDll, EntryPoint = "set_camera_range")]
