...
namespace lightning::graphics::direct3d12::d3dx {
	...
	struct D3D12RootSignatureDesc : public D3D12_ROOT_SIGNATURE_DESC1 {
		constexpr explicit D3D12RootSignatureDesc(const D3D12RootParameter* parameters, u32 parameter_count, D3D12_ROOT_SIGNATURE_FLAGS flags = D3D12_ROOT_SIGNATURE_FLAG_DENY_VERTEX_SHADER_ROOT_ACCESS | D3D12_ROOT_SIGNATURE_FLAG_DENY_HULL_SHADER_ROOT_ACCESS | D3D12_ROOT_SIGNATURE_FLAG_DENY_DOMAIN_SHADER_ROOT_ACCESS | D3D12_ROOT_SIGNATURE_FLAG_DENY_GEOMETRY_SHADER_ROOT_ACCESS | D3D12_ROOT_SIGNATURE_FLAG_DENY_AMPLIFICATION_SHADER_ROOT_ACCESS | D3D12_ROOT_SIGNATURE_FLAG_DENY_MESH_SHADER_ROOT_ACCESS, const D3D12_STATIC_SAMPLER_DESC* static_sampler = nullptr, u32 sampler_count = 0) : D3D12_ROOT_SIGNATURE_DESC1{ parameter_count, parameters, sampler_count, static_sampler, flags } {}
	...
	ID3D12Resource* create_buffer(u32 buffer_size, void* data = nullptr, bool is_cpu_accessible = false, D3D12_RESOURCE_STATES state = D3D12_RESOURCE_STATE_COMMON, D3D12_RESOURCE_FLAGS flags = D3D12_RESOURCE_FLAG_NONE, ID3D12Heap* heap = nullptr, u64 heap_offset = 0);
}